    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          >
            Prueba 7 días gratis <ArrowRight size={20} />
          </button>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Cada personaje viste según la época bíblica: desde ropas de Egipto antiguo hasta Jerusalén romana. Tu hijo ve, entiende y recuerda.
              </p>
            </div>

            {/* Feature 2: Diseñado para Adolescentes */}
            <div className="flex flex-col items-center text-center">
              <div className="bg-blue-100 p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600">
                No es un libro aburrido. Es un cómic visual que habla su lenguaje: personajes auténticos, emociones reales, preguntas importantes.
              </p>
            </div>

            {/* Feature 3: Historias Inspiradoras */}
            <div className="flex flex-col items-center text-center">
              <div className="bg-blue-100 p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600">
                Cada capítulo termina con una lección que inspira: fe, valor, amor. Tu hijo ve que las historias antiguas siguen siendo relevantes.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-blue-600 text-white py-20">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <button className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-4 px-8 rounded-lg text-lg transition flex items-center justify-center gap-2 mx-auto">
            Prueba 7 días gratis <ArrowRight size={20} />
          </button>
        </div>
      </section>
